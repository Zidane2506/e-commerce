                ...
                <ul class="items-center flex">
                    @if (Auth::check())
                        @if (Auth::user()->role == 'admin')
                            <li class="mx-3 py-6 md:py-0">
                                <a href="{{ route('admin.dashboard') }}" class="text-black md:text-white hover:underline">Dashboard</a>
                            </li>
                        ...
                        @else
                            <li class="mx-3 py-6 md:py-0">
                                <a href="{{ route('user.dashboard') }}" class="text-black md:text-white hover:underline">Dashboard</a>
                            </li>
                            <li class="ml-6 block md:hidden">
                                <button id="menu-toggler"
                                    class="relative flex z-50 items-center justify-center w-8 h-8 text-black md:text-white focus:outline-none">
