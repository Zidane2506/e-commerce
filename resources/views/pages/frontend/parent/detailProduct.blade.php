    ...
    <section class="bg-gray-100 py-8 px-4">
        <div class="container mx-auto">
            <ul class="breadcrumb">
                ...
                <li>
                    <a href="{{ route('detail.category', $product->category->slug) }}">{{ $product->category->slug }}</a>
                </li>
                <li>
                ...
                <div class="slider">
                    ...
                    <div class="preview">
                        <div class="item rounded-lg h-full overflow-hidden">
                            <img src="{{ $product->product_galleries()->exists() ? url('storage/product/gallery', $item->image) : 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mN88B8AAsUB4ZtvXtIAAAAASUVORK5CYII=' }}"
